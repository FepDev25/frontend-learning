...
class LinkedList {
    ...
    _getNode(index) {
        ...
        // Bucle estándar: corre 'index' veces para llegar al nodo correcto
    ...
    delete(index) {
        ...
        let deletedNode; // guardar el nodo que se va a borrar

        // Caso 1: Borrar el primer elemento (Head)
        if (index === 0) {
            deletedNode = this.head;
            this.head = this.head.next;
            // Si la lista queda vacía, tail también debe ser null
            if (this.length === 1) {
                this.tail = null;
            }
        } 
        // Caso 2: Borrar cualquier otro elemento
        else {
            // buscar explícitamente el nodo ANTERIOR (index - 1)
            ...
            // Si borramos el último, actualizamos el tail para que sea el anterior
